...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Choose the perfect plan for your warehouse management needs. No hidden fees, no surprises. Scale as you grow.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for small warehouses getting started',
  plan1Price: '$99',
  plan1Period: '/month',
  plan1CTA: 'Start Free Trial',
  plan1CTAHref: '/trial',
  plan2Name: 'Professional',
  plan2Description: 'Best for growing warehouse operations',
  plan2Price: '$299',
  plan2Period: '/month',
  ...
  plan3Description: 'For large-scale warehouse operations',
  plan3Price: 'Custom',
  ...
  bottomDescription:
    "We offer tailored ERP solutions for complex warehouse operations with specific requirements. Let's discuss how WarehousePro can transform your logistics.",
  ...
  const plans = [
    {
      ...
      price: billingCycle === 'annual' ? '$79' : config.plan1Price,
    ...
    },
    {
      ...
      price: billingCycle === 'annual' ? '$239' : config.plan2Price,
