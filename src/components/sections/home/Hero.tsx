...
const DEFAULT_HERO = {
  ...
  description:
    'Streamline inventory, optimize workflows, and boost productivity with our comprehensive warehouse management system. Built for modern logistics operations.',
  features: [
