...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    "Get in touch with our warehouse management experts. We'll help you streamline your operations and boost efficiency.",
  formTitle: 'Get Your Free Consultation',
  formDescription:
    "Tell us about your warehouse challenges and we'll show you how WarehousePro can help.",
  submitButton: 'Request Consultation',
  contactSectionTitle: 'Get in Touch',
  method1Title: 'Email Us',
  method1Description: 'Reach out via email',
  method1Contact: 'hello@warehousepro.com',
  ...
  office1Address: '123 Tech Street, Suite 400',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'Chicago',
  office2Address: '456 Logistics Ave, Floor 12',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Atlanta',
  office3Address: '789 Supply Chain Blvd, Building C',
  ...
  supportNote: '24/7 support available for all customers',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    'Describe your current warehouse management challenges, number of locations, SKUs, daily orders, etc.',
} as const;
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                  >
                    <option value="">Select your current ERP system</option>
